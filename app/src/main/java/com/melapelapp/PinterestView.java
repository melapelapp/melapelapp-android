                ...
                if (PinterestView.this.getVisibility() == VISIBLE && (deltaX > mTouchSlop || deltaY > mTouchSlop)) {
                    for (int i = 0; i < mChildRects.size(); i++) {
                        ...
                        if (contains) {
                            ...
                            x1 = event.getX();
                            y1 = event.getY();
                            ((CircleImageView) getChildAt(mChildRects.keyAt(i))).setFillColor(mContext.getResources().getColor(R.color.primary));
...
//                            if(!mPopTips.isShowing())
                            ...
                            for (int j = 0; j < mChildRects.size(); j++) {
                                if (j != i) {
                                    ...
                                    ((CircleImageView) getChildAt(mChildRects.keyAt(j))).setFillColor(mContext.getResources().getColor(R.color.accent));
                            ...
                            mPopTips.dismiss();
                            ((CircleImageView) getChildAt(mChildRects.keyAt(i))).setFillColor(mContext.getResources().getColor(R.color.accent));
    ...
    public void switchState(final boolean showAnimation) {
        ...
        if (showAnimation) {
            ...
            for (int i = 1; i < childCount; i++) {
                ((CircleImageView) getChildAt(i)).setFillColor(mContext.getResources().getColor(R.color.accent));
